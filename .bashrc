...
alias vsel='xclip -o -selection clipboard'
alias cpng='xclip -selection clipboard -t image/png -i'

## settings commands
alias sst='scrot -s' # 'gnome-screenshot -a -f'
alias screenshot='scrot'
alias enable-touchscreen='xinput enable 11'
alias disable-touchscreen='xinput disable 11'
alias disable-rotate='sudo systemctl stop iio-sensor-proxy.service'
alias disable-scroll='xmodmap -e "pointer = 1 25 3 4 5 6 7 8 9"'
alias xmod='xmodmap ~/.Xmodmap' # runs the ~/.Xmodmap file
alias sudoenv='sudo env PATH=$PATH'

## general shortcuts
alias notes='indicator-stickynotes'
alias alarm='alarm-clock-applet'
alias digip='dig +short myip.opendns.com @resolver1.opendns.com'
alias timer='gnome-clocks &'
alias alarm='alarm-clock-applet &'
alias xterm.load='xrdb ~/.Xresources'
# turn off bluetooth
alias bt.off='sudo /etc/init.d/bluetooth stop'
# turn on bluetooth
...
c() {
    ...
    __conda_setup="$('/home/tilde/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
    if [ $? -eq 0 ]; then
        eval "$__conda_setup"
    else
        if [ -f "/home/tilde/anaconda3/etc/profile.d/conda.sh" ]; then
            . "/home/tilde/anaconda3/etc/profile.d/conda.sh"
        else
            export PATH="/home/tilde/anaconda3/bin:$PATH"
        fi
    fi
    unset __conda_setup
    # <<< conda initialize <<<
